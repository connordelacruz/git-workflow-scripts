...
#
# Constants with full path to scripts.
# ==============================================================================

# Script Names -----------------------------------------------------------------
readonly BRANCH_SCRIPT_NAME=workflow-branch
readonly COMMIT_TEMPLATE_SCRIPT_NAME=workflow-commit-template
...
readonly COMMIT_TEMPLATE_SCRIPT="$SCRIPT_DIR/$COMMIT_TEMPLATE_SCRIPT_NAME"
